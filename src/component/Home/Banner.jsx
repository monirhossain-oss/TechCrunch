...
const Banner = () => {
    return (
        <div>
            <div className="bg-green-700 px-4 py-16 mt-16 md:mt-0 grid grid-cols-1 md:grid-cols-2 gap-6 min-h-screen">
                {/* Left Half */}
                <div className="group relative w-full h-[400px] md:h-full overflow-hidden cursor-pointer">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="grid grid-rows-2 gap-6">
                        <div className="group relative w-full h-[250px] md:h-96 overflow-hidden cursor-pointer">
                            {/* Background Image with zoom effect */}
                            <div
                            ...
                            <div className="absolute bottom-4 left-4 right-4 z-10">
                                ...
                                {/* Title with underline on hover */}
                                <h2 className="relative text-lg md:text-2xl font-extrabold text-white inline-block">
                                    <span className="border-b-0 border-white transition-all duration-300 group-hover:border-b-4 pb-1">
                                        Meta launches super PAC to fight AI regulation as state policies mount
                                    </span>
                                </h2>
            ...
            <div className="grid grid-cols-3  min-h-20">
                {/* Left side */}
